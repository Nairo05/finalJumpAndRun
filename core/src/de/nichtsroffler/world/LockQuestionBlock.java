...
public class LockQuestionBlock extends StaticObject {

    private TiledMap map;

    public LockQuestionBlock(World world, TiledMap map, Rectangle rectangle) {
    ...
    protected void defineStaticObject() {
        setFilter(BitFilterDef.ACTION_BLOCK, BitFilterDef.LOCK_ACTION_BLOCK);
        setUserData(LockQuestionBlock.this);
    }
